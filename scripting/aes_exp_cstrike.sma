...
public client_putinserver(id)
	if(!iDbType)
		set_task(0.1,"loadUserStats",id)	// ñòàòèñòèêà íå ñðàçó èíèöèàëèçèðóåòñÿ
...
public client_death(killer,victim,wpn,hit,TK){
	...
	// áîíóñû íå âêëþ÷åíû èëè âðåìåííî íå ðàáîòàþò
...
// áîíóñû ïðè ïîëó÷åíèè íîâîãî çâàíèÿ
...
// ïðîâåðêà íà êîë-âî áîíóñíûõ î÷êîâ èãðîêà
// cmpr - êàêîé ïàðàìåòð ïðîâåðÿåì
// Array:which - ïî êàêîìó ìàññèâó
...
// ïàðñåð çíà÷åíèé áîíóñîâ â ìàññèâ
public parse_aes_bonus_values(Array:which,levelString[]){
	...
	do {
		...
		// óçíàåì çíà÷åíèå ñ ïîçèöèè stPos è äëèííîé ePos
		...
		// äâà çíà÷åíèÿ áûëè íàéäåíû
		// çàïèñûâàåì èõ â ìàññèâ è ñáðàñûâàåì óêàçàòåëü
		if(stState == 2){
